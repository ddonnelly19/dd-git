    ...
    def mapProcessToPortsInSpecialWay(self):
        ...
        try:
            ...
            for pid, socket_descriptor in socket_descriptors:
                ...
                if local_ip and (ip_addr.isValidIpAddress(local_ip) and not ip_addr.IPAddress(local_ip).is_loopback):
...
class TCPDisBySunOSShell(TCPDisByLSOFableShell):
    ...
    def _get_ip_or_none(ip_string):
        ...
        try:
            ...
            return None
        if local_ipobject.is_loopback or str(local_ipobject) == '255.255.255.255':
            return None
