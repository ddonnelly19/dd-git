...
class Node:
    ...
    def getId(self):
        assert self.ip and self.port, 'Neither ip and port should not be empty'
...
class ConnectionDetails:
    ...
    def getSrcId(self):
        assert self.srcIp and self.srcPort, 'Neither source ip nor source port are specified'
        return (self.srcIp, self.srcPort)

    def getDstId(self):
        assert self.dstIp and self.dstPort, 'Neither destination ip nor destination port are specified'
