from oneview_mapping_interfaces import Mapping, LinkMapping, Link, Validator, InvalidValueException
from oneview_mapping_interfaces import CiMapping, AttributeMapping
import logger
...
class ReferenceLinkMapping(SimpleLinkMapping):
    def __init__(self, type, targetLinkName, sourceCi1Name, sourceCi2Name, referenceAttribute, targetCi1Name,
                 targetCi2Name, direction, failurePolicy, isContainer):
